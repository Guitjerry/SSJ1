...
public class PagerTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        sb.append(".pagination span.current {padding: 5px 10px;margin: 2px;border: 1px solid #ff0000;font-weight: bold;background-color: #ff0000;color: #FFF;border-radius:3px}");
